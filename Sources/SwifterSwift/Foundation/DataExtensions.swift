...
public extension Data {
    /// SS: Return data as an array of bytes.
    var bytes: [UInt8] {
...
public extension Data {
    /// SS: String by encoding Data using the given encoding (if applicable).
    ///
    ...
    /// SS: Returns a Foundation object from given JSON data.
    ///
