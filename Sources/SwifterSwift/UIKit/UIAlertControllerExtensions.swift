...
public extension UIAlertController {
    /// SS: Present alert view controller in the current view controller.
    ///
    /// - Parameters:
...
public extension UIAlertController {
    /// SS: Create new alert view controller with default OK action.
    ///
    /// - Parameters:
