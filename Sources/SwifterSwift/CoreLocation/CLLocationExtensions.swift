...
public extension CLLocation {
    ...
    /// SS: Calculate the half-way point along a great circle path between the two points.
    ///
    /// - Parameters:
    ...
    /// SS: Calculate the half-way point along a great circle path between self and another points.
    ///
    ...
    /// SS: Calculates the bearing to another CLLocation.
    ///
    /// - Parameters:
